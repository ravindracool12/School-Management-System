                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('email') }}" type="email" name="email" class="form-control" placeholder="your@gmail.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Phone:</label>
                                        <input value="{{ old('phone') }}" type="text" name="phone" class="form-control" placeholder="9120029239" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ old('phone2') }}" type="text" name="phone2" class="form-control" placeholder="9120029239" >
                                    </div>
                                </div>
